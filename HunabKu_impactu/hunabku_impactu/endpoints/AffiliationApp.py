...
class AffiliationApp(HunabkuPluginBase):
    config = Config()
    config += Param(
        db_uri="mongodb://localhost:27017/", doc="MongoDB string connection"
    )
            ...
            if tab == "products":
                ...
                if plot:
                    ...
                    if plot == "faculty_type":
                        result = self.get_products_by_affiliation_by_type(
                            idx, typ="faculty"
                        )
                    ...
                    if plot == "group_type":
                        ...
                        result = self.get_products_by_year_by_researcher_category(
                            idx, typ=typ
                        )
                        ...
                        result = self.get_citations_by_affiliations(
                            idx, typ="department"
                        )
                        ...
                        result = self.get_products_by_affiliations(
                            idx, typ="department"
                        )
